...
class TutorialCoachMark {
  ...
  TutorialCoachMark({
    ...
    if (targets.any((tF) => tF.allowBackgroundInteraction == true) &&
        pulseEnable == true) {
      throw Exception(
          'If there are any targets with allowBackgroundInteraction as true, then the pulseEnable parameter must be false.');
    }
  }
